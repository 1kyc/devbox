...
| More than one GitHub account stored | **hard stop** — only the active one can be checked |
...
113 assertions: the box's invariants, the scope check's refusals (with a fake
